...
{
    sealed class ActorNames
    {
        public const string Github = "GithubActors";
        ...
        public const string RepoLauncher = "repo_launcher";
        public const string RepoValidateCoordinator = "repo_vali_status_coor";
